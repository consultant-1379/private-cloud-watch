...
if [ $# -le 1 ]
then
	echo 'ed25519 [public key file] AND [service] string must be specified, e.g.: ~/.ssh/id_ed25519.pub "plogiston-server"'
	echo "usage: ed25519pubkeytojson.sh [public key file] [service]-required [username]-optional"
	exit 1
fi
