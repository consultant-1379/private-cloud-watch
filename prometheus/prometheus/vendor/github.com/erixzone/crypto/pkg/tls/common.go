...
func unsupportED25519ForTest() {
	k := len(supportedSignatureAlgorithms) - 1
	if supportedSignatureAlgorithms[k] == ED25519 {
		supportedSignatureAlgorithms = supportedSignatureAlgorithms[:k]
	}
}
